...
type ClusterApplicationResourceMappingSpec struct {
	...
	// Foo is an example field of ClusterApplicationResourceMapping. Edit clusterapplicationresourcemapping_types.go to remove/update
	Foo string `json:"foo,omitempty"`
}

// ClusterApplicationResourceMappingStatus defines the observed state of ClusterApplicationResourceMapping
type ClusterApplicationResourceMappingStatus struct {
...
type ClusterApplicationResourceMapping struct {
	...
	Status ClusterApplicationResourceMappingStatus `json:"status,omitempty"`
}
