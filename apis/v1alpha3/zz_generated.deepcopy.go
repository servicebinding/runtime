...
func (in *ClusterWorkloadResourceMappingSpec) DeepCopyInto(out *ClusterWorkloadResourceMappingSpec) {
	*out = *in
	if in.Versions != nil {
		...
		*out = make([]ClusterWorkloadResourceMappingVersion, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterWorkloadResourceMappingVersion) DeepCopyInto(out *ClusterWorkloadResourceMappingVersion) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterWorkloadResourceMappingVersion.
func (in *ClusterWorkloadResourceMappingVersion) DeepCopy() *ClusterWorkloadResourceMappingVersion {
	if in == nil {
		return nil
	}
	out := new(ClusterWorkloadResourceMappingVersion)
	in.DeepCopyInto(out)
	return out
}
