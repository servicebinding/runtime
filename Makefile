...
test: manifests generate fmt vet ## Run tests.
	...
	source ${ENVTEST_ASSETS_DIR}/setup-envtest.sh; fetch_envtest_tools $(ENVTEST_ASSETS_DIR); setup_envtest_env $(ENVTEST_ASSETS_DIR); $(GINKGO) -v -cover -coverpkg=./... -coverprofile=../cover.out ./...
