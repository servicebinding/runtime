...
require github.com/vmware-tanzu/carvel-kbld v0.37.6
...
require (
	...
	github.com/vmware-tanzu/carvel-imgpkg v0.37.3 // indirect
	github.com/vmware-tanzu/carvel-vendir v0.34.4 // indirect
