...
require github.com/vmware-tanzu/carvel-kbld v0.38.0
...
require (
	...
	github.com/vmware-tanzu/carvel-imgpkg v0.38.0 // indirect
	github.com/vmware-tanzu/carvel-vendir v0.35.0 // indirect
